 ...
 */
#define IMX_TEMP_PASSIVE		90000//85000
...
static int imx_get_sensor_data(struct platform_device *pdev)
{
	...
	/*Dynamic thermal grading */
	ret = regmap_read(map, IMX6_OCOTP_MEM0, &grade);
	if (ret) {
		dev_err(&pdev->dev, "failed to read thermal grade: %d\n", ret);
		return ret;
	}
	...
	/*
	 * Set MAX Temperature as the default critical trip point.
	 */
