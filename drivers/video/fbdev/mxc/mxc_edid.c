...
const struct fb_videomode mxc_cea_mode[64] = {
	...
	/*Included to support the EDID resolutions*/

	 /* #48: 640x480-60 VESA */
	[48] =  { NULL, 60, 640, 480, 39682,  48, 16, 33, 10, 96, 2,
	...
	/* #51: 800x600-75 VESA */
	[51] = { NULL, 75, 800, 600, 20202, 160, 16, 21, 01, 80, 3,
	  	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
	  	 FB_VMODE_NONINTERLACED, FB_MODE_IS_VESA 
	},
	/* #52: 1024x768-60 VESA */
	...
	/* #53: 1024x768-75 VESA */
	[53] = { NULL, 75, 1024, 768, 12690, 176, 16, 28, 1, 96, 3,
	  	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
	  	 FB_VMODE_NONINTERLACED, FB_MODE_IS_VESA 
	},
	/* #54: 1280x1024-60 VESA */
	[54] = { NULL, 60, 1280, 1024, 9259, 248, 48, 38, 1, 112, 3,
	  	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
	   	 FB_VMODE_NONINTERLACED, FB_MODE_IS_VESA 
	},
	/* #55: 1152x864-75 VESA */
	[55] = { NULL, 75, 1152, 864, 9259, 256, 64, 32, 1, 128, 3,
	  	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
	   	 FB_VMODE_NONINTERLACED, FB_MODE_IS_VESA 
	},
