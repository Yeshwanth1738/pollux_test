...
static int csi_enc_setup(cam_data *cam)
{
	...
	else if (cam->v2f.fmt.pix.pixelformat == V4L2_PIX_FMT_Y10)
		pixel_fmt = IPU_PIX_FMT_Y10;
	else if (cam->v2f.fmt.pix.pixelformat == V4L2_PIX_FMT_Y12)
		pixel_fmt = IPU_PIX_FMT_Y12;
	else if (cam->v2f.fmt.pix.pixelformat == V4L2_PIX_FMT_JPEG)
		pixel_fmt = IPU_PIX_FMT_JPEG;
	else {
