...
fec_probe(struct platform_device *pdev)
{
	...
	of_property_read_u32(np, "reset_mode0", &ndev->reset_mode0);
	of_property_read_u32(np, "reset_mode1", &ndev->reset_mode1);
	of_property_read_u32(np, "reset_mode2", &ndev->reset_mode2);
	of_property_read_u32(np, "reset_mode3", &ndev->reset_mode3);
