...
static void __init imx6q_clocks_init(struct device_node *ccm_node)
{
	...
	/****Added to support 7 inches diaply*********/
	...
	/* Set AHB to 132MHz*/
        ret = clk_set_rate(clk[IMX6QDL_CLK_AHB], 132000000);
        if (ret)
	...
	*/
	 ...
	 */
        clk_set_rate(clk[IMX6QDL_CLK_PLL4_AUDIO], 1083801600);
        clk_set_rate(clk[IMX6QDL_CLK_PLL4_AUDIO_DIV], 541900800);
        imx_clk_set_parent(clk[IMX6QDL_CLK_ESAI_SEL], clk[IMX6QDL_CLK_PLL4_AUDIO_DIV]);
        clk_set_rate(clk[IMX6QDL_CLK_ESAI_PRED], 270950400);
        clk_set_rate(clk[IMX6QDL_CLK_ESAI_PODF], 33868800);
	imx_clk_set_parent(clk[IMX6QDL_CLK_CKO2_SEL], clk[IMX6QDL_CLK_ESAI_EXTAL]);
        clk_set_rate(clk[IMX6QDL_CLK_CKO2], 11289600);
